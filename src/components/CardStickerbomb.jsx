    ...
    <div className="w-[800px] h-[400px] bg-[#fdfaf4]/90 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.15)] relative overflow-hidden flex font-sans border-2 border-white/50 rounded-3xl" style={{ isolation: 'isolate' }}>
      ...
      <div className="flex-1 relative flex">
        ...
        <div className="absolute bottom-8 right-12 z-20 opacity-60 mix-blend-multiply rotate-[-15deg]">
          <div className="w-24 h-24 rounded-full border-[3px] border-red-800 flex flex-col items-center justify-center p-2 relative bg-[#fdfaf4]/40">
            <span className="text-[10px] font-black text-red-800 uppercase tracking-widest leading-none text-center">GOA INDIA</span>
            <Plane className="w-7 h-7 text-red-800 my-1 rotate-45" fill="currentColor" />
            <span className="text-[8px] font-bold text-red-800 uppercase tracking-widest leading-none text-center">HACKER HOUSE</span>
